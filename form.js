document.addEventListener('DOMContentLoaded', function () {
    ...
    function generateMessage() {
        ...
        if (document.getElementById('formulario-clientes') !== null) { 
            ...
            mensaje = `
            Hola, he leído y aceptado los términos y condiciones. Me interesa publicitar en electricista.net.ar:
    ...
    if (messengerButton) {
        ...
        messengerButton.addEventListener('click', function () {
            const message = generateMessage();
            if (message) {
                const messengerLink = `https://www.messenger.com/t/electricista.net.ar?text=${encodeURIComponent(message)}`;
